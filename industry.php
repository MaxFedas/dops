								...
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Finance & Banking</div>
											<div class="desc">Internet banking, finance organizations</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Real Estate & Justice</div>
											<div class="desc">Construction, architectural and law companies</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Media & Entertainment</div>
											<div class="desc">Television, radio, cinema and gaming industry</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Advertising & Marketing</div>
											<div class="desc">PR-agencies, marketing and advertising agencies</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Technology & Innovations</div>
											<div class="desc">Innovative and scientific inventions</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Education & E-learning</div>
											<div class="desc">Smart learning and knowledge sharing projects</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Healthcare & Sports</div>
											<div class="desc">Useful health improving web and mobile programs</div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="ind_area">
						...
						<div class="ind_items">
							...
							<div class="item ind-item-1">
								...
								<div class="label rt">Real Estate & Justice</div>
							</div>
							<div class="item ind-item-2">
								<div class="icon">03</div>
								<div class="label rt">Media & Entertainment</div>
							</div>
							<div class="item ind-item-7">
								<div class="icon">04</div>
								<div class="label">Advertising & Marketing</div>
							</div>
							<div class="item ind-item-3">
								<div class="icon">05</div>
								<div class="label">Technology & Innovations</div>
							</div>
							<div class="item ind-item-6">
								<div class="icon">06</div>
								<div class="label rt">Education & E-learning</div>
							</div>
							<div class="item ind-item-4">
								<div class="icon">07</div>
								<div class="label">Healthcare & Sports</div>
							</div>
						</div>
					</div>
							...
							<div class="menu_popup_fx">
								<div class="menu lt">
									<ul>
										...
										<li class="active"><a href="industry.php" data-id="#mi_2">Industries</a></li>
									</ul>
								</div>
								<div class="menu rt">
									<ul>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="ukr/industry.php">укр</a> / <a href="industry.php" class="active">eng</a> / <a href="rus/industry.php">рус</a>
								</div>
							</div>
