    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        ...
        $('.pp-section').each(function (index) {
            ...
            // var div2 = $(".scroll-2"),
            //     div_sh2 = $(div2)[0].scrollHeight,
            //     div_h2 = div2.height();
            // $(div2).scroll(function(){
            //     if ($(this).scrollTop() >= div_sh2 - div_h2) {
            //        PP.moveSectionDown();
            //     } else if ($(this).scrollTop() == 0) {
            //         PP.moveTo(2);
            //     }
            ...
            $(".to-tab").on("click", function(){
                ...
                $(".tab[data-href='" + id + "'").addClass("is-active");
        ...
        */
        ...
        $(".map-block").on("touchmove", function(){
           removeTouchHandler();

        });

        // $(".gallery-cols").on("touchmove", function(){
        //     removeTouchHandler();
        // });
