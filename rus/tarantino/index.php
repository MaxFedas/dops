                ...
                <div class="s-top-mask">
                    ...
                    <div class="desc-wrap desc-menu socket">
                        ...
                        <div class="desc-item desc-item-2">
                            ...
                            <div class="text d-item">Никогда еще заказ еды в рестора не<br> был настолько легким и удобным</div>
                        </div>
                    </div>
                </div>
            </header>
                        ...
                        <div class="desc-item animate-item move-fade" data-q="1">
                            <div class="b-column">
                                ...
                                <p class="text">
                                    ...
                                    персонализации каж-<br/> дого пользователя приложения в зависимости<br/> от количества набранных общих баллов.
                                </p>
                            </div>
            ...
            <div class="s-wrap-o">
                            ...
                            <div class="desc-item">
                                ...
                                <div class="b-column d-item">
                                    ...
                                    <p class="text">
                                       ...
                                       в долгой очереди на освобождение столика,<br>
                                       вы можете зарезирвировать его всего в<br>
                                       два клика с помощью Tarantino App.
                                    </p>
                                </div>
                ...
                <div class="s-scope">
                    <div class="title-wrap animate-item">
                        ...
                        <div class="title-sub move-fade">Результаты реализации нашей работы</div>
                    ...
                    <div class="b-accomp b-shadow animate-item move-fade" data-screen="0.65">
                        ...
                        <div class="desc-item">
                            ...
                            <div class="b-column d-item">
                                ...
                                <div class="text">
                                    С помощью организации независимого заказа клиентом, нам 
                                    удалось уменшить на 17% загруженность оффициантов и почти 
                                    на треть сократить времья ожидания свободного столика.
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="column">
                            <div class="b-orders b-shadow animate-item move-fade" data-q="2">
                                <hgroup>
                                    ...
                                    <div class="title-3">Увеличились почти в 2 раза (тыс./мес.)</div>
                                </hgroup>
                        ...
                        <div class="column">
                            ...
                            <div class="b-repeat b-shadow animate-item move-fade" data-q="2">
                                <hgroup>
                                    ...
                                    <div class="title-3">Поднялись на 27% (тыс./мес.)</div>
                                </hgroup>
