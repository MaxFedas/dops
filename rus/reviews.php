		...
		<section class="wrapper">
			...
			<div class="section reviews centrize" id="s-reviews">
				<div class="no-vertical-center">
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>1. Результат соответствует ожиданиям. 2. Уделяется особое<br/> 
														внимание к пожеланиям заказчика. 3. Всегда на связи с<br/>  
														заказчиком - полный контроль процесса разработки.</p>
												</div>
												<!--<div class="bts">
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>Команда dops.bz создала сказочный сайт для нашей компании по<br/> 
														разработке программного обеспечения. В них действительно есть<br/>  
														ощущение того, что клиент ожидает и они переводят эти ощущения<br/> 
														в замечательный продукт.</p>
												</div>
												<!--<div class="bts">
													<a href="#" class="btn_link">
														<span class="icon"></span>
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>Ребята из компании dops.bz являются профессиональной командой,<br/> 
														с реактивной обратной связью и зажигательной проактивностью.<br/>  
														Работать с ними одно удовольствие!</p>
												</div>
												<!--<div class="bts">
													<a href="#" class="btn_link">
														<span class="icon"></span>
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>Компания dops.bz является трудолюбивой с набором навыков, которые обеспечивают превосходные проектные решения. Всегда совершенствуются, и задают много вопросов, прежде чем начинать работу, чтобы выяснить, что должно быть сделано. Их дизайн высокого качества и стоимости.</p>
												</div>
												<!--<div class="bts">
													<a href="#" class="btn_link">
														<span class="icon"></span>
					...
					<div class="s-text90">23 клиента</div>
					<div class="map_area">
						<div class="map_bg"></div>
						<div class="map_items">
							<a class="map_item map_item_1 hovered active">
								<span class="label">Москва, Россия</span>
								<span class="circle"></span>
							</a>
							<a class="map_item map_item_2">
								<span class="label">Киев, Украина</span>
								<span class="circle"></span>
							</a>
							<a class="map_item map_item_3">
								<span class="label">Львов, Украина</span>
								<span class="circle"></span>
							</a>
							<a class="map_item map_item_4">
								<span class="label">Нью-Йорк, США</span>
								<span class="circle"></span>
							</a>
						</div>
					</div>
