					...
					<div class="vertical-center">
						<div class="wrap">
							<div class="menu_popup_fx">
								...
								<div class="menu rt">
									<ul>
										<li class="active"><a href="portfolio.php" data-id="#mi_3">Портфолио</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="../ukr/porfolio.html">укр</a> / <a href="../portfolio.php">eng</a> / <a href="portfolio.php" class="active">рус</a>
								</div>
							</div>
