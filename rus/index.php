			...
			<div class="section started centrize" id="s-started">
				<div class="vertical-center">	
					<div class="wrap">
						...
						<div class="stitle">
							<div class="screen screen-1 glitch">
							  <div class="glitch-text"><span data-text="DOPS">DOPS</span></div>
							</div>
							<div class="blue-point"></div>
							<div class="screen screen-2 glitch">
							  <div class="glitch-text"><span data-text="DIGITAL">DIGITAL</span></div>
							</div>
						</div>
						<div class="sdesc wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
							<p>Эксперты по разработке живых приложений и сайтов для максимизации прибыли бизнеса.</p>
						</div>
						<div class="bts wow fadeIn" data-wow-duration="1s" data-wow-delay="1s">
							<a href="#" class="btn proj_btn" onclick="$('.order-btn').click(); return false;">Бесплатно оценить проект</a>
							<a href="portfolio.html" class="btn border make-order-btn" onclick="$('.cases-btn').click(); return false;">Посмотреть портфолио</a>
						</div>
						<div class="bts only-mobile">
							<a href="#" class="btn order_btn">Связаться с нами</a>
						</div>
						...
						<div class="lang wow fadeIn" data-wow-duration="1s" data-wow-delay="1s">
							<a href="../ukr/index.html">укр</a> / <a href="../index.html">eng</a> / <a href="index.html" class="active">рус</a>
						</div>
					</div>
