							...
							<div class="menu_popup_fx">
								<div class="menu lt">
									<ul>
										...
										<li class="active"><a href="process.php" data-id="#mi_5">Процесс</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="../ukr/process.php">укр</a> / <a href="../process.php">eng</a> / <a href="process.php" class="active">рус</a>
								</div>
							</div>
