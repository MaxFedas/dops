							...
							<div class="menu_popup_fx">
								...
								<div class="menu rt">
									<ul>
										...
										<li class="active"><a href="contacts.php" data-id="#mi_7">Contacts</a></li>
									</ul>
								</div>
								<div class="clr"></div>
								<div class="lang">
									<a href="ukr/contacts.php">укр</a> / <a href="contacts.php" class="active">eng</a> / <a href="rus/contacts.php">рус</a>
								</div>
							</div>
