		...
		<section class="wrapper">
			...
			<div class="section reviews centrize" id="s-reviews">
				<div class="no-vertical-center">
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>1. Результат відповідає очікуванням. 2. Приділяється особлива<br/> 
														увага до побажань замовника. 3. Завжди на зв'язку із<br/>  
														замовником - повний контроль процесу розробки.</p>
												</div>
												<!--<div class="bts">
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>Команда dops.bz створила казковий сайт для нашої компанії з<br/> 
														розробки програмного забезпечення. В них дійсно є відчуття<br/>  
														того, що клієнт очікує і вони переводять ці відчуття чудовий<br/> 
														продукт. Ми вже отримали безліч компліментів від сайту.</p>
												</div>
												<!--<div class="bts">
													<a href="#" class="btn_link">
														<span class="icon"></span>
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>Хлопці з компанії dops.bz є професійною командою, з реактивним<br/> 
														зворотнім зв'язком та запальною проактивністю.<br/>  
														Працювати з ними одне задоволення!</p>
												</div>
												<!--<div class="bts">
													<a href="#" class="btn_link">
														<span class="icon"></span>
									...
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="rt">
												...
												<div class="desc">
													<p>Компанія dops.bz є працьовитою, з набором навичок, які забезпечують чудові проектні рішення. Завжди вдосконалюються, і задають багато питань, перш ніж починати роботу, щоб з'ясувати, що має бути зроблено. Їхній дизайн високої якості і вартості.</p>
												</div>
												<!--<div class="bts">
													<a href="#" class="btn_link">
														<span class="icon"></span>
					...
					<div class="s-text90">23 клієнти</div>
					<div class="map_area">
						<div class="map_bg"></div>
						<div class="map_items">
							<a class="map_item map_item_1 hovered active">
								<span class="label">Москва, Росія</span>
								<span class="circle"></span>
							</a>
							<a class="map_item map_item_2">
								<span class="label">Київ, Україна</span>
								<span class="circle"></span>
							</a>
							<a class="map_item map_item_3">
								<span class="label">Львів, Україна</span>
								<span class="circle"></span>
							</a>
							...
							<div class="menu_popup_fx">
								...
								<div class="menu rt">
									<ul>
										...
										<li class="active"><a href="reviews.html" data-id="#mi_6">Відгуки</a></li>
										<li><a href="contacts.html" data-id="#mi_7">Контакти</a></li>
									</ul>
								</div>
								<div class="clr"></div>
								<div class="lang">
									<a href="reviews.html" class="active">укр</a> / <a href="../reviews.html">eng</a> / <a href="../rus/reviews.html">рус</a>
								</div>
							</div>
