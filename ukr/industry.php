								...
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Фінанси і банкінг</div>
											<div class="desc">Інтернет-банкінг, фінансові організації</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Будівництво і юриспунденція</div>
											<div class="desc">Будівельні, архітектурні й юридичні компанії</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Медіа та розваги</div>
											<div class="desc">Телебачення, радіо, кінематограф та ігрова індустрія</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Реклама і маркетинг</div>
											<div class="desc">PR-агенції, маркетингові та рекламні агенства</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Технології та інновації</div>
											<div class="desc">Науково-інноваційні винаходи та їх технології</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Онлайн навчання</div>
											<div class="desc">Розумне навчання і проекти обміну знаннями</div>
										</div>
									</div>
									<div class="swiper-slide">
										<div class="item">
											...
											<div class="name">Здоров’я та спорт</div>
											<div class="desc">Корисні програми для зміцнення стану здоров’я</div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="ind_area">
						...
						<div class="ind_items">
							<div class="item ind-item-5 active hovered">
								...
								<div class="label">Фінанси і банкінг</div>
							</div>
							<div class="item ind-item-1">
								<div class="icon">02</div>
								<div class="label rt">Будівництво і юриспунденція</div>
							</div>
							<div class="item ind-item-2">
								<div class="icon">03</div>
								<div class="label rt">Медіа та розваги</div>
							</div>
							<div class="item ind-item-7">
								<div class="icon">04</div>
								<div class="label">Реклама і маркетинг</div>
							</div>
							<div class="item ind-item-3">
								<div class="icon">05</div>
								<div class="label">Технології та інновації</div>
							</div>
							<div class="item ind-item-6">
								<div class="icon">06</div>
								<div class="label rt">Онлайн навчання</div>
							</div>
							<div class="item ind-item-4">
								<div class="icon">07</div>
								<div class="label">Здоров'я та спорт</div>
							</div>
						</div>
					</div>
							...
							<div class="menu_popup_fx">
								<div class="menu lt">
									<ul>
										...
										<li class="active"><a href="industry.html" data-id="#mi_2">Індустрії</a></li>
									</ul>
								</div>
								<div class="menu rt">
									<ul>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="industry.html" class="active">укр</a> / <a href="../industry.html">eng</a> / <a href="../rus/industry.html">рус</a>
								</div>
							</div>
