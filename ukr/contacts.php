			...
			<div class="section contacts centrize" id="s-contacts">
				<div class="vertical-center">
					<div class="wrap">
						<div class="lt">
							<div class="c_info c_info_1">
								...
								<div class="bts only-mobile">
									<a class="btn" href="#" onclick="$('.order-btn').click(); return false;">Зв'язатися з нами</a>
								</div>
							</div>
							<div class="c_info c_info_3">
								<div class="htitle htitle-start">Маєте запитання? <span>Задайте його прямо зараз</span></div>
								...
								<div class="c_form">
									<form method="post" id="contact-form">
										...
										<div class="bts">
											<a href="#" class="btn" onclick="$('#contact-form').submit(); return false;">Відправити</a>
										</div>
									</form>
								</div>
							</div>
						...
						<div class="c_map">
							<a class="marker">
								<span>м. Львів <em>вул. Заводська 31</em></span>
							</a>
							...
							<div class="menu_popup_fx">
								...
								<div class="menu rt">
									<ul>
										...
										<li class="active"><a href="contacts.html" data-id="#mi_7">Контакти</a></li>
									</ul>
								</div>
								<div class="clr"></div>
								<div class="lang">
									<a href="contacts.html" class="active">укр</a> / <a href="../contacts.html">eng</a> / <a href="../rus/contacts.html">рус</a>
								</div>
							</div>
