					...
					<div class="vertical-center">
						<div class="wrap">
							<div class="menu_popup_fx">
								...
								<div class="menu rt">
									<ul>
										<li class="active"><a href="portfolio.php" data-id="#mi_3">Портфоліо</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="portfolio.php" class="active">укр</a> / <a href="../portfolio.php">eng</a> / <a href="../rus/portfolio.php">рус</a>
								</div>
							</div>
