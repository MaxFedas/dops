		...
		<section class="wrapper">
			...
			<div class="section portfolio centrize" id="s-portfolio">
				<div class="no-vertical-center">
					<div class="wrap">
						<div class="tabs">
							<a class="active">нові</a> / <a>великі</a>
						</div>
								...
								<div class="swiper-slide">
									<div class="case_item">
										<a href="/debtmarket/" target="_blank">
											...
											<span class="desc">Інформаційний портал</span>
										</a>
									</div>
								</div>
								<div class="swiper-slide">
									<div class="case_item">
										<a href="tarantino/" target="_blank">
											...
											<span class="desc">Мобільний додаток</span>
										</a>
									</div>
								</div>
								<div class="swiper-slide">
									<div class="case_item">
										<a href="/dacollection/" target="_blank">
											...
											<span class="desc">Корпоративний сайт</span>
										</a>
									</div>
								</div>
								<!--
					...
					<div class="vertical-center">
						<div class="wrap">
							<div class="menu_popup_fx">
								...
								<div class="menu rt">
									<ul>
										<li class="active"><a href="portfolio.html" data-id="#mi_3">Портфоліо</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="portfolio.html" class="active">укр</a> / <a href="../portfolio.html">eng</a> / <a href="../rus/portfolio.html">рус</a>
								</div>
							</div>
