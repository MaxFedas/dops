							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Цільові<br/> сторінки</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Створюємо довершену презентацію вашого бізнеса чи ідеї. Придумуємо еффективну концепцію, малюємо унікальну графіку і оживлюємо її за допомогою анімації. Продаємо продукт силою захоплень.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Корпоративні<br/> веб-сайти</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Структуруємо послуги, проговоривши їх з замовником або довіреними йому особами. Після чого будуємо прототип сайту на перевагах компанії, дотримуючись тональності бренду, або ще краще – освіжаючи його.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Інформаційні<br/> портали</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Унікальний досвід у створенні проектів, які опрацьовують великі об’єми даних зі складними взаємозв'язками інтерфейсу і частою відвідуваністю сайту, додає нам впевненості в тому, що немає нічого неможливого.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Комерційні<br/> платформи</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Спеціалізуємось на створенні унікальних інтернет-магазинів, здатних успішно продавати і конкурувати. Доповнюємо їх власними рішеннями для отримання максимальної конверсії на здійснення покупки.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Мобільні<br/> програми</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Програми для щоденної роботи – найкраща можливість не лише забрендувати персональний пристрій вашого клієнта, але й забезпечити максимальне захоплення уваги користувача в продукт компанії.</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="menu_popup_fx">
								<div class="menu lt">
									<ul>
										...
										<li class="active"><a href="services.html" data-id="#mi_4">Послуги</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="services.html" class="active">укр</a> / <a href="../services.html">eng</a> / <a href="../rus/services.html">рус</a>
								</div>
							</div>
