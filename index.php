...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>		
				...
				<div class="vertical-center">
					<div class="wrap">
						<div class="menu_popup_fx">
							<div class="menu lt">
								<ul>
									<li class="active"><a class='goToPage' data-id="#mi_1" data-goto="home">Home</a></li>
									<li><a class='goToPage' data-id="#mi_4" data-goto="services">Services</a></li>
									<li><a class='goToPage' data-id="#mi_5" data-goto="process">Process</a></li>
									<li><a class='goToPage' data-id="#mi_2" data-goto="industries">Industries</a></li>
								</ul>
							</div>
							<div class="menu rt">
								<ul>
									<li><a class='goToPage' data-id="#mi_3" data-goto="portfolio">Portfolio</a></li>
									<li><a class='goToPage' data-id="#mi_8" data-goto="values">Values</a></li>
									<li><a class='goToPage' data-id="#mi_6" data-goto="feedback">Feedback</a></li>
									<li><a class='goToPage' data-id="#mi_7" data-goto="contacts">Contacts</a></li>
								</ul>
							</div>
							<div class="clr"></div>
							<div class="lang">
		...
		<div id='contentIndex' class='pageContent slide'  data-loadedcontent='true' data-anchor="home">
			...
			<!-- Section Started -->
			<div class="sectionWrap started centrize" id="s-started">
				<div class="vertical-center">	
					<div class="wrap">
