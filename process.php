				...
				<div class="vertical-center">
					<div class="wrap">
						<div class="lt">
							<div class="proc_tabs">
								<div class="proc_tab" id="proc-tab-1">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Business strategy analysis</div>
											<div class="desc">
												<p>We start with a short but detailed discussion of your business or idea to understand the vision of the final product and we also gather all of the demands, determine price and the terms of the project.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-2">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Prototyping user experience</div>
											<div class="desc">
												<p>Prototyping user experience is vital for gaining positive experience in all aspects of interaction with the product, which in its turn will increase conversion and competitive efficiency on the market.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-3">
									<div class="vcontent">	
										...
										<div class="info">
											<div class="name">Unique product interface design</div>
											<div class="desc">
												<p>We unite your business goals with the consumers’ needs with unique design, which will make your product, stand out on the market and will leave your competitors with no chance.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-4">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Responsive layout product</div>
											<div class="desc">
												<p>Rich experience in creating web resources and mobile applications gives us an opportunity for quality adaption of released products to any trend existing on the market.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-5">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Interactive animation</div>
											<div class="desc">
												<p>Dops.bz company is interested in product stability, performance,  issues, your product maintenance and support requirements in other side due to increase a quality of it’s own portfolio.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-6">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Back-end programming</div>
											<div class="desc">
												<p>We will start with a brief but detailed discussion so that we can understand your vision of the product, gather requirements, and properly scope out your project pricing and timeline.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-7">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Quality testing of each detail</div>
											<div class="desc">
												<p>We will dig into the product to pass all possible user scenarios, will load the system and use different testing techniques and tools so that the product launched will meet customer expectations and user needs.</p>
											</div>
										</div>
									</div>
								</div>
								<div class="proc_tab" id="proc-tab-8">
									<div class="vcontent">
										...
										<div class="info">
											<div class="name">Maintenance and support</div>
											<div class="desc">
												<p>Dops.bz company is interested in product stability, performance,  issues, your product maintenance and support requirements in other side due to increase a quality of it’s own portfolio.</p>
											</div>
										</div>
							...
							<div class="proc_line">
								<div class="label">Business strategy analysis</div>
								<div class="line">
									<i class="start">0%</i>
						...
						<div class="rt">
							<div class="proc_menu">
								<a href="#proc-tab-1"
								  data-time="5"
								  data-spec="3"
								  data-label="Business strategy analysis" 
								  ...
								  class="active">
									<span>1</span> Business<br/> analysis
								</a>
								<a href="#proc-tab-2"
  								  data-time="9"
								  data-spec="2"
								  data-label="Prototyping user experience"
								  ...
								   <span>5</span> Interactive<br/> animation
								</a>
								<a href="#proc-tab-6"
								  data-time="10"
								  data-spec="2"
								  data-label="Back-end programming"
								  ...
								  data-graph2="M3139.855,607.471l-0.066-431.753c0,0-52.783,61.374-169.025,61.374   c-136.779,0-262.113-176.311-422.426-176.311c-160.312,0-221.519,176.311-430.548,176.311c-188.198,0,73.66-133.595-96.173-133.595   c-179.5,0-138.484-59.997-310.484-59.997c-190,0-99.216,14.217-282.231,14.284c-170.504,0.063-187.549,170.873-430.548,176.311   C822.848,238.021,761.804,87.471,595.97,90.637c-163.008,3.112-232.764,143.353-399.763,143.353   c-148.676,0-271.071-228.45-429.813-225.22c-148.969,3.031-682.63,148.603-687.13,151.442c0,82,0,433.758,0,433.758   L3139.855,607.471z">
									<span>6</span> Back-end<br/> programming
								</a>
								<a href="#proc-tab-7"
								  data-time="7"
								  data-spec="3"
								  data-label="Quality testing of each detail"
								  ...
								  data-graph2="M3383.855,607.471l-0.066-431.753c0,0-52.783,61.374-169.025,61.374   c-136.779,0-262.113-176.311-422.426-176.311c-160.312,0-221.519,176.311-430.548,176.311c-188.198,0,73.66-133.595-96.173-133.595   c-179.5,0-138.484-59.997-310.484-59.997c-190,0-340.116,194.485-523.132,194.553c-170.504,0.063-248.273-180.206-422.25-180.206   c-175.549,0-266.417,181.539-439.397,176.248C407.391,229.11,334.725,99.675,167.97,90.637   C15.728,82.385-59.259,230.822-218,234.053c-148.969,3.031-454.236-76.681-458.736-73.841c0,82,0,433.758,0,433.758   L3383.855,607.471z">
									<span>7</span> Quality testing <br/> of each detail
								</a>
								<a href="#proc-tab-8"
								  data-time="4"
								  data-spec="2"
								  data-label="Maintenance and support"
								  ...
								  data-graph2="M3948.85,427.634l-0.066-259.416c0,0-52.783,61.374-169.024,61.374   c-136.78,0-262.114-176.311-422.427-176.311c-160.312,0-221.519,176.311-430.548,176.311   c-188.197,0-232.549-143.458-402.382-143.458c-179.5,0-224.174,143.458-396.174,143.458c-190,0-257.561-225.374-431.007-225.374   c-187.22,0-30.52,40.333-243.22,40.333c-207.78,0-240.633,185-427,185c-159.245,0-270.333-179.332-423.25-176.206   C453.095,56.425,347.334,230.885,159,230.551c-149-0.265-332.034-143-389-143c0,82-1,341-1,341L3948.85,427.634z">
									<span>8</span> Maintenance<br/> and support
								</a>
							</div>
						</div>
					</div>
							...
							<div id="graph">
                                ...
                                <div class="labels">
                                    <div class="label label-1">
                                        <div>
                                            <span>5%</span> Of full cycle development
                                        </div>
                                    </div>
                                </div>
							...
							<div class="menu_popup_fx">
								<div class="menu lt">
									<ul>
										...
										<li class="active"><a href="process.html" data-id="#mi_5">Process</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="ukr/process.html">укр</a> / <a href="process.html" class="active">eng</a> / <a href="rus/process.html">рус</a>
								</div>
							</div>
