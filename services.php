							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Landing<br/> pages</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">We аrе create a sophisticated presentation of your business or idea. We come up with an effective concept, draw unique graphics and smoothly animate it. We sell the product by using the power of impression.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Corporate<br/> Websites</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Structuring services, by talking with the customer or their trusted persons. Then building a website prototype on the company's advantages, keeping the tone of the brand, or even better – refreshing it.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Information<br/> Portals</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Unique experience in the creation of projects which work with large amounts of data and complex interface communications on high-traffic websites adds to our confidence in the fact that there is nothing impossible.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Commercial<br/> Platforms</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">We specialize in creating unique online stores which can sell successfully and compete on the e-commerce market. We complement them by our own decisions in order to maximize on the user’s purchase conversion.</p>
											</div>
										</div>
									</div>
									<div class="swiper-slide">	
										<div class="item">
											<div class="desc">
												<h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">Mobile<br/> Applications</h3>
												<p class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Applications for daily work - the best opportunity not only brand your customer’s device, but also ensure maximum involvement in your company or its product.</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="menu_popup_fx">
								<div class="menu lt">
									<ul>
										...
										<li class="active"><a href="services.php" data-id="#mi_4">Services</a></li>
								...
								<div class="clr"></div>
								<div class="lang">
									<a href="ukr/services.php">укр</a> / <a href="services.php" class="active">eng</a> / <a href="rus/services.php">рус</a>
								</div>
							</div>
